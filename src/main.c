...
int main(int argc, char **argv) { 
    ...
    //createErrorGif(1);
    //createTypingGIF("Hello! This GIF was generated by my GIF encoder! 123 TESTING 12TEST 65345HELLO");
    createTypingGIF("Aa Bb Cc Dd Ee Ff Gg Hh Ii Jj Kk Ll Mm Nn Oo Pp Qq Rr Ss Tt Uu Vv Ww Xx Yy Zz 1 2 3 4 5 6 7 8 9 !");
